    ...
    <div id="about" className="w-full md:h-screen p-2 flex items-center py-16 mx-2">
        <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
            ...
            <p className="py-2 text-gray-600">
              ...
              personal blog and decided to learn more about web development. 
            ...
            <p className="py-2 text-gray-600">
              ...
              I also learned Javascript libraries and frameworks like React JS and Next JS respectively, along with database management using Microsoft 
            </p>
            </div>
            <div>
            </div>
