...
const About = () => {
  return (
    <div className="w-full md:h-screen p-2 flex items-center py-16 mx-4">
        <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
            ...
            <p className="py-2 text-gray-600">
              After receiving my Residency Visa this January, I enrolled with <b>Whitecliffe College of Art and Design</b> to
            </p>
            </div>
            <div>
            </div>
