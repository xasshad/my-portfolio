  ...
  return (
    <div className="w-full md:h-screen p-2 flex items-center py-16">
        <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
            ...
            <p className="py-2 text-gray-600 italic font-light">*:･ﾟ✧*:･ﾟ I'm a rookie who wants to rise to the top  *:･ﾟ✧*:･ﾟ</p>
            ...
            <p>
              After receiving my Residency Visa this January, I enrolled with 
              <b className="font-bold">Whitecliffe College of Art and Design</b>
            </p>
            </div>
            <div>
            </div>
