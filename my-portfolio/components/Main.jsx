...
const Main = () => {
  return (
    <div className="w-full h-screen text-center">
        <div className="max-w-[1240px] w-full h-full mx-auto md:grid-cols-2 p-2 flex justify-center items-center">
            <div>
                ...
                <p className="py-4 text-gray-600 max-w-[70%] m-auto">
                    ...
                    Currently working on deploying responsive front-end websites while learning back-end technologies.
                </p>
